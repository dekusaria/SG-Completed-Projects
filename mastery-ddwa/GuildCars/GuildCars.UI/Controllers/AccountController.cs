...
namespace GuildCars.UI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            {
                ModelState.AddModelError("", "User has been disabled. Contact Administrator for more info.");
                return View(model);
            }
                ...
                if (result.Succeeded)
                {
                    switch (model.Role)
                    {
                        ...
                        case "disabled":
                            ...
                            break;
                        case null:
                            throw new Exception("User Role cannot be null, Register aborted.");
                    }
        ...
        public async Task<ActionResult> EditUser(EditUserViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var roles = userMgr.GetRoles(user.Id).ToArray();

                userMgr.RemoveFromRoles(user.Id, roles);
